...
extern int amzn_usb_get_portOcEvtCnt(void);
extern int amzn_usb_get_hubOcEvtCnt(void);
extern int amzn_usb_get_vbusForcedOff(void);
...
static ssize_t portOcEvtCnt_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	ssize_t rc;
	rc = sprintf(buf, "%d\n", amzn_usb_get_portOcEvtCnt());
	return rc;
}
static DEVICE_ATTR_RO(portOcEvtCnt);

static ssize_t hubOcEvtCnt_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	ssize_t rc;
	rc = sprintf(buf, "%d\n", amzn_usb_get_hubOcEvtCnt());
	return rc;
}
static DEVICE_ATTR_RO(hubOcEvtCnt);

static ssize_t vbusForcedOff_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	ssize_t rc;
	rc = sprintf(buf, "%d\n", amzn_usb_get_vbusForcedOff());
	return rc;
}
static DEVICE_ATTR_RO(vbusForcedOff);
...
static struct attribute *dev_attrs[] = {
	...
	&dev_attr_portOcEvtCnt.attr,
	&dev_attr_hubOcEvtCnt.attr,
	&dev_attr_vbusForcedOff.attr,
	/* device attributes */
