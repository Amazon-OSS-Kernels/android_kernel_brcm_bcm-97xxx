...
static int ohci_init (struct ohci_hcd *ohci)
{
	...
	/* if OHCI_QUIRK_HUB_POWER flag is set OHCI controller doesn't poweroff in
	   case of over-current change event but we want OHCI controller to
	   poweroff in that case, hence make sure this flag is not set.
	*/
