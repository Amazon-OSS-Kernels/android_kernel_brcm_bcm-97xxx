...
void __iomem *brcmstb_ahci_top_ctrl_base;
EXPORT_SYMBOL(brcmstb_ahci_top_ctrl_base);

void __iomem *brcmstb_ahci_mmio_base;
EXPORT_SYMBOL(brcmstb_ahci_mmio_base);
...
static int brcm_ahci_probe(struct platform_device *pdev)
{
	...
	brcmstb_ahci_top_ctrl_base = priv->top_ctrl;
	...
	brcmstb_ahci_mmio_base = hpriv->mmio;
