...
static DEFINE_MUTEX(clamp_lock);
...
static int powerclamp_get_commanded_state(struct thermal_cooling_device *cdev,
				 unsigned long *state)
{
	/* Report commanded target ratio */
...
static struct thermal_cooling_device_ops powerclamp_cooling_ops = {
	...
	.get_cur_state = powerclamp_get_commanded_state,
