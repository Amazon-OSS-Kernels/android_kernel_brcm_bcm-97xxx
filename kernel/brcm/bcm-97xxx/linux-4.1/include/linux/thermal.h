...
/* Change the value to "0" since the logic in thermal framework is all unsigned */
#define THERMAL_TEMP_INVALID	0 //-274000
 ...
 * @trip_start_time: starting time entering a trip point
 * @last_trip: trip point last entered
 */
struct thermal_zone_device {
	int id;
	char type[THERMAL_NAME_LENGTH];
	...
	struct timespec trip_start_time;
	int last_trip;
};
...
{ }
static inline void monitor_thermal_zone(struct thermal_zone_device *tz)
{ }
...
static inline struct thermal_zone_device *thermal_zone_get_zone_by_name(
		const char *name)
{ return ERR_PTR(-ENODEV); }
static inline struct thermal_zone_device *thermal_zone_get_zone_by_id(
		int id)
{ return ERR_PTR(-ENODEV); }
