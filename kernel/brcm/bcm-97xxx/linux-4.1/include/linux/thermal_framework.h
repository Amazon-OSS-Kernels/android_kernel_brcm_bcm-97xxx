...
/*
 * If thermal sensor failed, we will return this temperature and let device reboot to try to recover itself
 * This will give a very large temperature and cause a critical temperature shutdown
 */
#define SENSOR_FAILED_RETURN_TEMP 1000000
