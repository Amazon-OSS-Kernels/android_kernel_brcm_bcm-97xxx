...
typedef enum {
	...
	THERMAL_SHUTDOWN_REASON_HDD     = 0x307,
	THERMAL_SHUTDOWN_REASON_OTHER1  = 0x308,
	THERMAL_SHUTDOWN_REASON_OTHER2  = 0x309,
	THERMAL_SHUTDOWN_REASON_FAN     = 0x30A,
	THERMAL_SHUTDOWN_REASON_SENSOR  = 0x30B,
	...
	LIFE_CYCLE_SMODE_HDD            = 0x405,
	LIFE_CYCLE_SMODE_TUNER          = 0x406,
}life_cycle_reason_t;
