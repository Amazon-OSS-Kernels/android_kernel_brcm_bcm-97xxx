...
#ifdef __KERNEL__
#ifdef CONFIG_HDD_THERMAL
extern int scsi_thermal_dev_register(struct scsi_device* scsid);
extern int scsi_thermal_dev_unregister(struct scsi_device* scsid);
#else //CONFIG_HDD_THERMAL
static inline int scsi_thermal_dev_register(struct scsi_device* scsid) { return 0; }
static inline int scsi_thermal_dev_unregister(struct scsi_device* scsid) {return 0; }
#endif //CONFIG_HDD_THERMAL
#endif //__KERNEL__
